...
| <a name="input_egress_deployment_name"></a> [egress\_deployment\_name](#input\_egress\_deployment\_name) | Optional override for the egress Deployment name. If null or empty, the default name is used. | `string` | `null` | no |
...
| <a name="input_egress_extra_deployment_labels"></a> [egress\_extra\_deployment\_labels](#input\_egress\_extra\_deployment\_labels) | Llabel that defines an additional identity for the egress gateway.<br/>This label is applied to:<br/>  - Deployment metadata.labels | `map(string)` | `{}` | no |
...
| <a name="input_egress_topology_spread_constraints"></a> [egress\_topology\_spread\_constraints](#input\_egress\_topology\_spread\_constraints) | List of topologySpreadConstraints to apply to the egress Deployment(s). See k8s apps/v1 TopologySpreadConstraint schema. | `any` | `null` | no |
...
| <a name="input_prefix"></a> [prefix](#input\_prefix) | Prefix value to append to the name of the resources. The name of the egress resources created with this module will be in format of <prefix>-<name>. | `string` | `null` | no |
